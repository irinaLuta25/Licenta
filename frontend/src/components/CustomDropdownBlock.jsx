...
function CustomDropdownBlock({ value, onChange, options }) {
  ...
  return (
    <Listbox value={value} onChange={onChange}>
      <div className="w-full"> 
        ...
        <ListboxOptions
  className="static z-10 mt-1 w-full rounded-xl bg-white text-gray-800 py-1 shadow-lg ring-1 ring-black/5 focus:outline-none transition-all duration-200"
>
          {options.map((opt) => (
            <ListboxOption
              key={opt.value}
