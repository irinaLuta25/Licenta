...
function TherapistCard({ therapist }) {
  ...
  return (
    <div className="bg-indigo-300 border border-indigo-300/30 shadow-xl hover:shadow-2xl shadow-[0_10px_20px_rgba(0,0,0,0.08)] drop-shadow-lg rounded-xl transition transform duration-300 hover:-translate-y-1 overflow-hidden p-4 flex flex-col justify-between">
      <img
      ...
      <div>
        ...
        <p className="text-slate-700 text-sm mt-1">{shortDescription}</p>
